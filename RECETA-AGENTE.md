...
<link rel="canonical" href="https://www.lasaluddelmarketing.com/articulos/{{SLUG}}.html">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"BlogPosting","headline":"{{TITULO}}","name":"{{TITULO}}","description":"{{DESCRIPCION_SEO}}","url":"https://www.lasaluddelmarketing.com/articulos/{{SLUG}}.html","publisher":{"@type":"Organization","name":"La Salud del Marketing","url":"https://www.lasaluddelmarketing.com"},"author":{"@type":"Person","name":"Jesús Sánchez Domínguez"}}</script>
